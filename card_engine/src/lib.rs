...
//
// 2026082301 — `Printing` gains `set_rank` and `artist_rank`, the dense ranks the six new
...
//
// 2026082302 — `OracleCard.card_name_folded` becomes an interned `card_name_folded_id`, taking
